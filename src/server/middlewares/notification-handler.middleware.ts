...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'proposal_submitted.create': { roles: ['owner', 'recruiter'], key: 'proposal', tenantPath: [], userPath: [] },
  'freelancer_shortlisted.update': { roles: ['owner', 'recruiter'], key: 'shortlist', tenantPath: [], userPath: [] },
  'freelancer_approved.update': { roles: ['owner', 'recruiter'], key: 'approval', tenantPath: [], userPath: [] },
};
