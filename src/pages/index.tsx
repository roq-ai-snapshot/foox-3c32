  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Foox - Your Global Job Marketplace. Connecting Companies and Freelancers, Redefining the Future of Work"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Foox - Your Global Job Marketplace. Connecting Companies and Freelancers, Redefining the Future of Work`}
            </Text>
            <Box
